...
app.layout = html.Div(children=[
    ...
    html.H3(children='Observatorio de vacantes en línea',
        style={'textAlign': 'center'
                },
),
    html.Div([
    ...
    html.H6(children='*No todos los países cuentan con la variable de no. de vacantes por aviso. Aquí sólo se grafican el no. de avisos.',
        style={'textAlign': 'center'
                },
),
...
def update_graph(xaxis_column_name, yaxis_type):
    ...
    return {
        ...
        'layout': dict(
            ...
            title={
                'text': 'Nuevos avisos de vacantes en: <br>{}'.format(xaxis_column_name),
                'xanchor': 'auto',
                'y': 0.9})
        }
